...
window.onload = function () {
	...
	let span = document.querySelectorAll('.nav-item.nav-item1 span');
	let bigbox = document.querySelectorAll('.drop .drop-bigbox');
	console.log(bigbox);
	...
	for (let i = 0; i < els.length; i++) {
		...
		els[i].onmouseenter = function () {
			...
			console.log(this.querySelector('.drop'))
		}
		els[i].onmouseleave = function () {
